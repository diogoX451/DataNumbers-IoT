...
import (
	...
	acls_service "github.com/nextsync/gateway-broker/internal/app/services/acls"
	grpc_service "github.com/nextsync/gateway-broker/internal/app/services/grpc"
	historys_service "github.com/nextsync/gateway-broker/internal/app/services/historys"
	"github.com/nextsync/gateway-broker/internal/infra/database"
	"github.com/nextsync/gateway-broker/internal/infra/database/adapter"
	"github.com/nextsync/gateway-broker/internal/infra/database/repository"
	"github.com/nextsync/gateway-broker/internal/infra/messaging/nats"
	grpc_transport "github.com/nextsync/gateway-broker/internal/infra/transport/grpc"
	grpc_adapter "github.com/nextsync/gateway-broker/internal/infra/transport/grpc/adapter"
	"github.com/nextsync/gateway-broker/internal/infra/transport/http"
	ginAdapter "github.com/nextsync/gateway-broker/internal/infra/transport/http/adapter"
	mqtt_transport "github.com/nextsync/gateway-broker/internal/infra/transport/mqtt"
	mqtt_adapter "github.com/nextsync/gateway-broker/internal/infra/transport/mqtt/adapter"
